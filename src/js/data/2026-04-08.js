...
dataSet[dataSetVersion].characterData = [{
  ...
  name: "Chisa",
  img: "T_IconRoleHead256_57_UI.webp",
  opts: {
    type: ["havoc"],
    weapon: ["broadblade"],
    rarity: ["s5"],
  ...
  name: "Buling",
  img: "T_IconRoleHead256_58_UI.webp",
  opts: {
    type: ["electro"],
    weapon: ["rectifier"],
    rarity: ["s4"],
  ...
  name: "Lynae",
  img: "T_IconRoleHead256_60_UI.webp",
  opts: {
    type: ["spectro"],
    weapon: ["pistols"],
    rarity: ["s5"],
  ...
  name: "Mornye",
  img: "T_IconRoleHead256_61_UI.webp",
  opts: {
    type: ["fusion"],
    weapon: ["broadblade"],
    rarity: ["s5"],
  ...
  name: "Aemeath",
  img: "T_IconRoleHead256_53_UI.webp",
  opts: {
    type: ["fusion"],
    weapon: ["sword"],
    rarity: ["s5"],
  ...
  name: " Luuk Herssen",
  img: "T_IconRoleHead256_54_UI.webp",
  opts: {
    type: ["spectro"],
    weapon: ["gauntlets"],
    rarity: ["s5"],
  ...
  name: "Sigrika",
  img: "T_IconRoleHead256_65_UI.webp",
  opts: {
    type: ["aero"],
    weapon: ["gauntlets"],
    rarity: ["s5"],
  ...
  name: "Hiyuki",
  img: "T_IconRoleHead256_67_UI.webp",
  opts: {
    type: ["glacio"],
    weapon: ["sword"],
    rarity: ["s5"],
  ...
  name: "Denia",
  img: "T_IconRoleHead256_64_UI.webp",
  opts: {
    type: ["fusion"],
    weapon: ["rectifier"],
    rarity: ["s5"],
